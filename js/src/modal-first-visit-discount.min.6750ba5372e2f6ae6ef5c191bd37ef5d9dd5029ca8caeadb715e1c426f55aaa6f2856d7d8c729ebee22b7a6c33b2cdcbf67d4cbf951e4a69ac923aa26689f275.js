const checkIfFirstVisit=()=>{const a=document.createElement('div');a.innerHTML=`
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-5">
              ...
              <a href="/pricing/?fvd=true" class="hexagon-btn heaxagon-btn-cta-yellow button" style="max-width: 100%;">
                <div class="hexagon-body-left-arrow"></div>
                <div class="hexagon-body-right-arrow"></div>
                <div class="hexagon-body">Claim your discount</div>
              </a>
            </div>
          </div>
        </div>
  ...
  `,document.body.appendChild(a),setTimeout(()=>{const a=new coreui.Modal(document.getElementById('modal-first-visit'));a.toggle(),setCookie('firstVisitOnPricing',!0,365),typeof dataLayer!='undefined'&&dataLayer.push({event:'first-visit-modal-show'})},5e3)};window.onload=function(){getCookie('firstVisitOnPricing')!=='true'&&checkIfFirstVisit()}