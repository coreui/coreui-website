...
if(parseInt(last.PaymentProvider)===1){form.innerHTML=`Please use the following link to download your order - <a href="https://gumroad.com/purchases/${last.PurchaseID}/receipt">Download</a>`}else{const table=document.createElement('table')
...
td.classList.add('c-table-light','c-font-weight-bold')
tr.appendChild(td)
...
button.classList.add('c-btn','c-btn-sm','c-btn-coreui','btn-download')
