const checkIfFirstVisit=()=>{const a=document.createElement('div');a.innerHTML=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{const a=new coreui.Modal(document.getElementById('modal-first-visit'));a.toggle(),setCookie('firstVisit',!0,365),typeof dataLayer!='undefined'&&dataLayer.push({event:'first-visit-modal-show'})},2500)};window.onload=function(){getCookie('firstVisit')!=='true'&&checkIfFirstVisit()}