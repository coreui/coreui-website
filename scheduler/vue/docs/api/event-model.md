...
The type is exported as `SchedulerEvent` from `@coreui/vue-scheduler`.
...
the [edit scope](https://coreui.io/scheduler/vue/docs/features/recurrence/), and everything the scheduler does to
