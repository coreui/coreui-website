...
`,"src/scss/styles.scss":S,"src/app/app.component.ts":C,...w},dependencies:h,openFile:`src/app/${f.name}`}}function a(e){let t=i(e);t.dependencies[`@coreui/scheduler`]=`latest`;for(let[e,n]of Object.entries(t.files))/styles\.(css|scss)$/.test(e)&&(t.files[e]=`@import "@coreui/scheduler/dist/css/scheduler.min.css";\n${n}`);return t}window.coreuiDocsSandbox=a,window.coreuiDocsSandboxTargets=void 0;