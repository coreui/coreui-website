...
| <kbd>F2</kbd> | Event | Open the [edit dialog](https://coreui.io/scheduler/angular/docs/features/recurrence/#editing-occurrences) (title, times, color, repeat). |
...
rejected drops when [overlap control](https://coreui.io/scheduler/angular/docs/features/overlap/) is on. Every
message is localizable through the [labels](https://coreui.io/scheduler/angular/docs/customization/localization/)
system.
