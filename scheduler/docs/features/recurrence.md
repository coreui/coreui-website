...
```html
<div id="schedulerRecurrence"></div>
```
...
new coreui.Scheduler(document.getElementById('schedulerRecurrence'), {
  dayStartHour: 7,
  dayEndHour: 19,
  events: [
    {
...
The initial scope comes from the `recurringEditScope` option. With the
