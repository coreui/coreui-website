# CoreUI Scheduler for React

> React resource and time scheduler — day, week, month, agenda, resource and timeline views with drag & drop, RFC 5545 recurrence, DST-safe time handling and full keyboard support.

CoreUI Scheduler for React is a resource and time scheduler for planning
...
export const SchedulerOverviewExample = () => (
  <CScheduler
    dayStartHour={7}
    dayEndHour={20}
...
- **Six views.** [Day & week](https://coreui.io/scheduler/react/docs/views/day-week/), [month](https://coreui.io/scheduler/react/docs/views/month/),
  [agenda](https://coreui.io/scheduler/react/docs/views/agenda/), a [resource view](https://coreui.io/scheduler/react/docs/views/resources/) with columns
  per room, person or machine — virtualized past a dozen resources — and a
  horizontal [timeline](https://coreui.io/scheduler/react/docs/views/timeline/).
- **Real recurrence.** Events carry raw
  [RFC 5545 RRULE strings](https://coreui.io/scheduler/react/docs/features/recurrence/); expansion is windowed and
...
- **Accessible by design.** Every drag operation has a keyboard equivalent
  ...
  technologies. See [Keyboard & accessibility](https://coreui.io/scheduler/react/docs/features/keyboard-accessibility/).
- **Themeable.** Every knob is a `--cui-scheduler-*` CSS variable resolving
  ...
  CSS. See [Styling & theming](https://coreui.io/scheduler/react/docs/customization/styling/).
- **One engine, every framework.** All scheduling logic lives in the headless
  `@coreui/scheduler-core`; `<CScheduler>` is a thin React rendering layer
  over it, behavior-identical to the vanilla edition.
...
Head to [Installation](https://coreui.io/scheduler/react/docs/getting-started/installation/) and the
[Quickstart](https://coreui.io/scheduler/react/docs/getting-started/quickstart/), or explore the views from the
sidebar.
