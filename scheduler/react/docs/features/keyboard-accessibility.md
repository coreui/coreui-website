...
| <kbd>F2</kbd> | Event | Open the [edit dialog](https://coreui.io/scheduler/react/docs/features/recurrence/#editing-occurrences) (title, times, color, repeat). |
...
rejected drops when [overlap control](https://coreui.io/scheduler/react/docs/features/overlap/) is on. Every
message is localizable through the [labels](https://coreui.io/scheduler/react/docs/customization/localization/)
system.
...
- Creating events with the keyboard is available in the time-grid views;
  ...
  your own UI on top of `onEventChange`.
