...
The type is exported as `SchedulerEvent` from `@coreui/react-scheduler`.
...
into it. Whatever you pass in, `onEventChange` payloads always carry ISO
...
the [edit scope](https://coreui.io/scheduler/react/docs/features/recurrence/), and everything the scheduler does to
your data goes through `onEventChange` — the arrays you get from
