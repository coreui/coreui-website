...
and is mutually exclusive with [pagination](https://coreui.io/data-grid/vue/docs/features/pagination/).
...
with [server-side data](https://coreui.io/data-grid/vue/docs/features/server-side-data/).

See the [Performance guide](https://coreui.io/data-grid/vue/docs/guides/performance/) for tuning advice.
...
```vue
<CDataGrid :columns="columns" :items="items" auto-row-height :row-height="44" />
```
