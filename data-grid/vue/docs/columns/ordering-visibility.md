# Vue Data Grid Column Ordering & Visibility
...
[column menu](https://coreui.io/data-grid/vue/docs/columns/menu/) offers a keyboard-accessible Move to start/end as an
