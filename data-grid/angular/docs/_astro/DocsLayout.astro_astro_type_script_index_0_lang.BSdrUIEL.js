...
`,"src/scss/styles.scss":S,"src/app/app.component.ts":C,...w},dependencies:h,openFile:`src/app/${f.name}`}}window.coreuiDocsSandbox=i,window.coreuiDocsSandboxTargets=void 0;