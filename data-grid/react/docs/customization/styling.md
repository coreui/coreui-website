# React Data Grid Styling & Theming

> Theme the React Data Grid with --cui-data-grid-* CSS variables that resolve through CoreUI semantic tokens, so light and dark modes work with no extra CSS.
...
```tsx
<CDataGrid className="my-grid" columns={columns} items={items} />
```
...
[Installation](https://coreui.io/data-grid/react/docs/getting-started/installation/).
