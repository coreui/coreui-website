# React Data Grid Cell Selection

> Spreadsheet-style cell ranges in the React Data Grid — shift-click, drag and shift+arrows, with Ctrl/Cmd+C copying the range as tab-separated text ready to paste into Excel.
...
[keyboard navigation](https://coreui.io/data-grid/react/docs/features/keyboard-navigation/) already provides.
...
export const DataGridCellSelectionExample = () => (
  <CDataGrid
    columns={[
...
Each copy fires ``onCellCopy`` with the exact text written, so you can mirror it
...
[feature set](https://coreui.io/data-grid/react/docs/customization/feature-sets/) — which is exactly what the lite
build does.
