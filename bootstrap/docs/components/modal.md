...
- Once again, due to `position: fixed`, there are some caveats with using modals on mobile devices. [See our browser support docs](https://coreui.io/bootstrap/docs/getting-started/browsers-devices/#modals-and-dropdowns-on-mobile) for details.
...
[Tooltips](https://coreui.io/bootstrap/docs/components/tooltips/) and [popovers](https://coreui.io/bootstrap/docs/components/popovers/) can be placed within modals as needed. When modals are closed, any tooltips and popovers within are also automatically dismissed.
