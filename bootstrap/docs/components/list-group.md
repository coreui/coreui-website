...
<li class="list-group-item list-group-item-${c.name}">A simple ${c.name} list group item</li>
...
<a href="#" class="list-group-item list-group-item-action list-group-item-${c.name}">A simple ${c.name} list group item</a>
...
Add badges to any list group item to show unread counts, activity, and more with the help of some [utilities](https://coreui.io/bootstrap/docs/utilities/flex/).
...
@mixin list-group-item-variant($state, $variant) {
  ...
  --cui-list-group-color: #{$color};
  --cui-list-group-bg: #{$background};
  --cui-list-group-hover-bg: #{$background-hover};
  --cui-list-group-action-hover-color: #{$color};
  --cui-list-group-action-active-color: #{$white};
  --cui-list-group-action-active-bg: #{$color};
  --cui-list-group-action-active-border-color: #{$color};
}
```
