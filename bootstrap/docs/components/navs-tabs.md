...
Change the horizontal alignment of your nav with [flexbox utilities](https://coreui.io/bootstrap/docs/utilities/flex/#horizontal-alignment). By default, navs are left-aligned, but you can easily change them to center or right aligned.
...
Add dropdown menus with a little extra HTML and the [dropdowns JavaScript plugin](https://coreui.io/bootstrap/docs/components/dropdowns/#usage).
