...
Wrap a series of buttons with `.btn` in `.btn-group`. Add on optional JavaScript radio and checkbox style behavior with [our buttons plugin](https://coreui.io/bootstrap/docs/components/buttons/#button-plugin).
...
These classes can also be added to groups of links, as an alternative to the [`.nav` navigation components](https://coreui.io/bootstrap/docs/components/navs-tabs/).
...
Combine button-like checkbox and radio [toggle buttons](https://coreui.io/bootstrap/docs/forms/checks-radios/) into a seamless looking button group.
