...
> Gutters are the padding between your columns, used to responsively space and align content in the CoreUI for Bootstrap grid system.
...
Gutter classes can also be added to [row columns](https://coreui.io/bootstrap/docs/layout/grid/#row-columns). In the following example, we use responsive row columns and responsive gutter classes.
