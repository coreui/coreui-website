...
For a richer, tool-based integration, see [MCP Server](https://coreui.io/bootstrap/docs/ai-tools/mcp/).
...
[Open llms.txt](https://coreui.io/bootstrap/docs/llms.txt)

## /llms-full.txt

The entire documentation concatenated into a single Markdown file, so a model can ingest the whole set in one request.

[Open llms-full.txt](https://coreui.io/bootstrap/docs/llms-full.txt)
...
For example: [/bootstrap/docs/components/accordion.md](https://coreui.io/bootstrap/docs/components/accordion.md)
