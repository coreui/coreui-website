...
| `rfs` | Optional | `false` | Boolean to enable [fluid rescaling with RFS](https://coreui.io/bootstrap/docs/getting-started/rfs/). |
...
As a list, like with [`text-decoration` utilities](https://coreui.io/bootstrap/docs/utilities/text/#text-decoration):

```scss
values: none underline line-through
```

As a map, like with [`opacity` utilities](https://coreui.io/bootstrap/docs/utilities/opacity/):
...
As a Sass variable that sets the list or map, as in our [`position` utilities](https://coreui.io/bootstrap/docs/utilities/position/):
...
Add the `responsive` boolean to generate responsive utilities (e.g., `.opacity-md-25`) across [all breakpoints](https://coreui.io/bootstrap/docs/layout/breakpoints/).
