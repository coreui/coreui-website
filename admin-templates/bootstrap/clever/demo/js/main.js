...
var doughnutData = new Chart($('#doughnut-chart'), {
  type: 'doughnut',
  data: {
    labels: ['Chrome', 'Firefox', 'Safari', 'Edge', 'Other'],
    datasets: [{
      data: [35, 20, 15, 10, 20],
      backgroundColor: [getStyle('--success'), getStyle('--primary'), getStyle('--info'), getStyle('--danger'), getStyle('--warning')],
      hoverBackgroundColor: [hexToRgba(getStyle('--success'), 90), hexToRgba(getStyle('--primary'), 90), hexToRgba(getStyle('--info'), 90), hexToRgba(getStyle('--danger'), 90), hexToRgba(getStyle('--warning'), 90)]
    }]
  },
  options: {
    responsive: true,
