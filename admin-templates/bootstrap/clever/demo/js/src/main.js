...
// eslint-disable-next-line no-unused-vars
const doughnutData = new Chart($('#doughnut-chart'), {
  type: 'doughnut',
  data: {
    ...
    datasets: [{
      ...
      hoverBackgroundColor: [
        hexToRgba(getStyle('--success'), 90),
        hexToRgba(getStyle('--primary'), 90),
        hexToRgba(getStyle('--info'), 90),
        hexToRgba(getStyle('--danger'), 90),
        hexToRgba(getStyle('--warning'), 90)
      ]
    }]
  },
  options: {
