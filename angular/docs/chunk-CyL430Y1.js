import{$t as Uv,Br as kw,Fi as v,Nt as Rs,T as D_,Ut as Td,i as $v,kt as RM,qr as lv,ur as gd}from"./chunk-D4QfcjgQ.js";import"./chunk-BwrHBgAX.js";import{Ui as nr,Xi as y}from"./main-CRW2IFLY.js";import{t as f}from"./chunk-CircK-BE.js";var g=class s{constructor(){this.headService=v(y);this.name=`CSS Variables`;this.title=`CSS variables`;this.description=`Use CoreUI CSS custom properties for fast and forward-looking design and development.`}ngOnInit(){this.headService.updateHeader({title:this.title,name:this.name,description:this.description})}static{this.ɵfac=function(t){return new(t||s)}}static{this.ɵcmp=D_({type:s,selectors:[[`docs-customize-css-variables`]],decls:23,vars:5,consts:[[`id`,`getting-started`],[1,`docs-lead`,`fs-4`,`fw-light`],[`markdown`,``,1,`highlight`]],template:function(t,c){t&1&&(Rs(0,`h1`,0),RM(1),gd(),Rs(2,`p`,1),RM(3),gd(),lv(4,`docs-ads-carbon-loader`),Rs(5,`markdown`),RM(6,`
  ...
  **All our custom properties are prefixed with \`cui-\`** to avoid conflicts with third party CSS.
  ...
  Here are the variables we include (note that the \`:root\` is required) that can be accessed anywhere CoreUI CSS is loaded. They're located in our \`_root.scss\` file and included in our compiled dist files.
`),gd(),Rs(7,`pre`,2),RM(8),gd(),Rs(9,`markdown`),RM(10,`
...
`),gd(),Rs(17,`pre`,2),RM(18),gd(),Rs(19,`markdown`),RM(20,`
  `),lv(21,`br`),RM(22,`
...
`),gd()),t&2&&(kw(),Uv(c.title),kw(2),Uv(c.description),kw(5),Td("  ```css\n  :root ",`{`,`
    --cui-blue: #0d6efd;
    --cui-indigo: #6610f2;
    --cui-purple: #6f42c1;
    --cui-pink: #d63384;
...
`),kw(10),$v("  ```css\n  body ",`{`,`
  ...
  \`\`\`
`))},dependencies:[f,nr],encapsulation:2})}};export{g as CustomizeCssVariablesComponent};