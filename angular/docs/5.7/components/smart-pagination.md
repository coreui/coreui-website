...
| `dots` | `boolean` | `true returns boolean` | Show/hide dots. |
| `doubleArrows` | `boolean` | `true` | Show double arrows buttons |
| `firstButton` | `string \| TemplateRef<any>` | `'&laquo'` | The content of 'firstButton' button. |
| `lastButton` | `string \| TemplateRef<any>` | `'&raquo'` | The content of 'lastButton' button. |
| `limit` | `number` | `5` | Maximum items number. |
| `nextButton` | `string \| TemplateRef<any>` | `'&lsaquo'` | The content of 'nextButton' button. |
| `pages` | `number` | `1` | Number of pages. |
| `previousButton` | `string \| TemplateRef<any>` | `'&rsaquo'` | The content of 'previousButton' button. |
