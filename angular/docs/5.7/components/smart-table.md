...
- `columnFilter_*` <small>(see: [Custom Filters](https://coreui.io/angular/docs/5.7/components/smart-table/#custom-filters))</small>
- `columnLabel_*` <small>(<div class="badge bg-info badge-sm">~4.7.7</div> see: [Custom Headers](https://coreui.io/angular/docs/5.7/components/smart-table/#custom-headers))</small>
