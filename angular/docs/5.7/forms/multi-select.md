...
| `cleaner` | `boolean \| 'active'` | `true \| 'active'` | Enables selection cleaner element |
...
| `value` | Option value <br /> `number` type allowed since <span class="badge bg-primary badge-sm">4.7.5+</span>| `string \| number` |_undefined_|
