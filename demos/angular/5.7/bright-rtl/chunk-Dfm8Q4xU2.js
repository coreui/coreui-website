...
`),nu()),l&2&&(vD(35),_m(`visible`,i.basicVisible),vD(70),bm(`
              ...
              or shortcut.
            `),vD(32),_m(`visible`,i.offcanvasVisible))},dependencies:[vF,ux,Ro,JS,Po,I,c,XF,BF,VF,LF,RF,Ws,MF,wF,z2,jF,$F,UF,HF,tf,L2],encapsulation:2})}};export{G as AppSearchButtonComponent};