import{Ii as zw,Rr as nu,Yr as rC,_i as vD,qr as qg,ri as rs,rn as Wg,tn as Wb}from"./chunk-C5fCWXIE.js";import"./chunk-B5RQ6SWk.js";import{$n as ux,R as JS,W as KF,an as fF,ht as Ro,lt as Po}from"./main-WNNPZAX2.js";import{t as I}from"./chunk-BdGtYA52.js";import"./chunk-DOWvcPSI.js";import"./chunk-B0N1zF-G.js";import{t as c}from"./chunk-wX8vMM_b.js";var b=()=>[`Low`,`Medium`,`High`];var y=()=>[25,75];var C=()=>[20,40];var R=()=>[20,40,60];var w=()=>[20,40,60,80];var F=()=>[20,80];var _=()=>[20,80,100];var v=()=>[50,75];var A=()=>[`Start`,`Middle`,`End`];var M=()=>[30,70];var f=class m{static{this.ɵfac=function(d){return new(d||m)}}static{this.ɵcmp=zw({type:m,selectors:[[`app-range-sliders`]],decls:194,vars:24,consts:[[`xs`,`12`],[`href`,`forms/range-slider/`],[1,`mb-4`],[1,`text-body-secondary`,`small`],[1,`bg-body`,`border`,`rounded`,`p-3`],[3,`labels`,`value`],[`href`,`forms/range-slider/#multiple-handles`],[1,`bg-body`,`border`,`rounded`],[3,`value`],[`href`,`forms/range-slider/#vertical-range-slider`],[1,`d-flex`,`bg-body`,`border`,`rounded`],[`vertical`,``,3,`value`],[`href`,`forms/range-slider/#min-and-max`],[`max`,`150`,`min`,`-50`,3,`value`],[`href`,`forms/range-slider/#distance`],[`distance`,`10`,3,`value`],[`href`,`forms/range-slider/#labels`]],template:function(d,D){d&1&&(rs(0,`c-row`),Wb(1,`
  `),rs(2,`c-col`,0),Wb(3,`
    ...
    `),nu(),Wb(192,`
  `),nu(),Wb(193,`
`),nu()),d&2&&(vD(26),Wg(`labels`,rC(13,b))(`value`,rC(14,y)),vD(26),Wg(`value`,rC(15,C)),vD(2),Wg(`value`,rC(16,R)),vD(2),Wg(`value`,rC(17,w)),vD(26),Wg(`value`,20),vD(2),Wg(`value`,rC(18,F)),vD(2),Wg(`value`,rC(19,_)),vD(44),Wg(`value`,50),vD(2),Wg(`value`,rC(20,v)),vD(29),Wg(`value`,rC(21,v)),vD(26),Wg(`labels`,rC(22,A))(`value`,rC(23,M)))},dependencies:[Po,Ro,JS,ux,c,I,KF,fF],styles:[`[_nghost-%COMP%]   .range-slider[_ngcontent-%COMP%]{padding:.7rem}`]})}};export{f as RangeSlidersComponent};