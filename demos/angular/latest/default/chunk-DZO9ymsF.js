import{$ as JT,$n as eb,Hr as ow,Ii as zw,In as b,Ir as nm,Kt as Tm,Pn as au,Rr as nu,_i as vD,mr as iw,on as XT,qr as qg,ri as rs,rn as Wg,tn as Wb}from"./chunk-C5fCWXIE.js";import"./chunk-B5RQ6SWk.js";import{$n as ux,An as oF,Bn as rF,F as Ii,G as Kv,R as JS,St as Tm$1,Vt as ZN,Zt as cf,an as fF,ar as wr,b as Dr,ft as QN,ht as Ro,i as $2,lt as Po,m as CF,pr as yF,ur as xr,x as Ds,yn as ko}from"./main-RVV5WB5K.js";import{t as I}from"./chunk-BeaAyQ9m.js";import"./chunk-BLFJbqdn.js";import"./chunk-B0N1zF-G.js";import{t as c}from"./chunk-BZj1vhCh.js";function W(r,l){if(r&1&&(Wb(0,`
  ...
  `),rs(389,`c-col`,0),Wb(390,`
    ...
    `),nu(),Wb(475,`
  `),nu(),Wb(476,`
`),nu()),a&2&&(vD(26),eb(o.sampleList),vD(35),eb(o.sampleList),vD(35),eb(o.sampleList),vD(50),eb(o.sampleList),vD(32),eb(o.sampleList),vD(43),eb(o.breakpoints),vD(28),eb(o.colors),vD(20),eb(o.colors),vD(29),eb(o.sampleList),vD(32),Wg(`active`,!0),vD(79),Wg(`formGroup`,o.checkBoxes),vD(2),Wg(`flush`,!0),vD(6),iw(),vD(11),iw(),vD(11),iw(),vD(11),iw(),vD(11),iw())},dependencies:[fF,ux,Ro,JS,Po,I,CF,yF,$2,xr,QN,Kv,Ii,Ds,Dr,wr,oF,rF,cf,Tm$1,ko,c],encapsulation:2})}};export{R as ListGroupsComponent};