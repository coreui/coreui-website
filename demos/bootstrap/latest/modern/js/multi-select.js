...
/**
 * Multi-Select Component Demonstrations
 *
 * This module initializes multiple CoreUI MultiSelect components on the Multi Select page
 * (views/forms/multi-select.html). The MultiSelect component provides an enhanced select
 * dropdown with search, multiple selection, and various display modes.
 *
 * Features demonstrated:
 * - Single selection mode
 * - Multiple selection with different display types:
 *   - Counter: Shows "X items selected"
 *   - Text: Shows comma-separated list of selected items
 *   - Tags: Shows selected items as removable tags
 * - Search/filtering functionality
 * - Inline vs dropdown display modes
 * - Option groups
 * - Dynamic updates (select1c.update() example)
 * - Programmatic vs HTML-based initialization
 *
 * Configuration options:
 * - multiple: Allow selecting multiple items
 * - search: Enable search/filter functionality
 * - selectionType: 'counter', 'text', or 'tags'
 * - inline: Display as inline list instead of dropdown
 * - selection: Show/hide the selection area
 * - options: Programmatically defined options (or use <option> in HTML)
 *
 * This file contains 16 different MultiSelect instances (select-1 through select-16)
 * demonstrating various configuration combinations.
 *
 * @see https://coreui.io/bootstrap/docs/forms/multi-select/
 */

/**
 * Sample options data with groups for programmatic initialization
 */
const options = [
  {
    value: 0,
...
/**
 * Alternative options data for demonstrating dynamic updates
 */
const options2 = [
  {
    value: 0,
...
// Programmatic MultiSelect instances with JavaScript options
...
// HTML-based MultiSelect instances (options defined in HTML <option> tags)
