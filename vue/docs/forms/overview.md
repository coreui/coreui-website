...
<script setup>
import { CForm, CFormLabel, CFormInput, CFormText, CFormCheck, CButton } from '@coreui/vue'
</script>
```
...
<script setup>
import { CForm, CFormLabel, CFormInput, CFormText } from '@coreui/vue'
</script>
```
...
<script setup>
import { CRow, CCol, CFormLabel, CFormInput, CFormText } from '@coreui/vue'
</script>
```
...
<script setup>
import { CForm, CFormLabel, CFormInput, CFormSelect, CFormCheck, CButton } from '@coreui/vue'
</script>
```
