# Vue Bootstrap Floating labels Component

> Learn how to use CoreUI’s Vue Floating labels component with Bootstrap styles for flexible, framework-consistent UI.
