...
<span class="token punctuation">/&gt;</span></span>
</code></pre></div>`,1),J={class:"docs-example rounded-top p-4"},R=s(`<div class="language-vue" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>CChart</span>
