...
> Track and review changes to the CoreUI for Vue.js components to help you migrate from v3 to v4.

CoreUI for Vue is the Vue.js version of CoreUI components library, so before read this migration guide, please check also [CoreUI 3 to 4 migration guide](https://coreui.io/bootstrap/docs/migration/v4/).
