import{Y as Q,_ as nn,o as en,c as rn,a as on}from"./app-27e1995f.js";const tn=`//
// Base styles
//
...
`,ve=`// All-caps \`RGBA()\` function used because of this Sass bug: https://github.com/sass/node-sass/issues/2251
@each $color, $value in $theme-colors {
...
`,Re=`@mixin bsBanner($file) {
  /*!
   * CoreUI PRO #{$file} v5.0.0-alpha.1 (https://coreui.io)
...
`,Ge=`// This mixin uses an \`if()\` technique to be compatible with Dart Sass
...
`,Xe=`@include deprecate("\`list-group-item-variant()\`", "v4.3.0", "v6.0.0");
...
}`;var Z=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function ur(v){return v&&v.__esModule&&Object.prototype.hasOwnProperty.call(v,"default")?v.default:v}var W={exports:{}};(function(v){var E=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
