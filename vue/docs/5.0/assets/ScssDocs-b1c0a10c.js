import{Y as Q,_ as nn,o as en,c as rn,a as on}from"./app-69e5539a.js";var W=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function tn(h){return h&&h.__esModule&&Object.prototype.hasOwnProperty.call(h,"default")?h.default:h}const an=`//
// Base styles
//
...
`,Dn=`// stylelint-disable function-disallowed-list
...
`,Ee=`// stylelint-disable property-disallowed-list
...
`,De=`// Breakpoint viewport sizes and media queries.
//
...
`,Xe=`@include deprecate("\`list-group-item-variant()\`", "v5.0.0", "v6.0.0");
...
`,nr="// Resize anything\n\n@mixin resizable($direction) {\n  overflow: auto; // Per CSS3 UI, `resize` only applies when `overflow` isn't `visible`\n  resize: $direction; // Options: horizontal, vertical, both\n}\n",er=`// scss-docs-start table-variant
...
`,or=`// stylelint-disable property-disallowed-list
...
`,dr=`// stylelint-disable function-disallowed-list
...
`,cr=`@each $color, $value in $theme-gradients {
  .bg-#{$color}-gradient {
...
`,pr=`// stylelint-disable scss/dimension-no-non-numeric-values
