...
const CAccordionBody = vue.defineComponent({
    name: 'CAccordionBody',
    setup(_, { slots }) {
        return () => vue.h('div', { class: ['accordion-body'] }, slots.default && slots.default());
    },
});
...
const CAccordionButton = vue.defineComponent({
    ...
    setup(props, { slots }) {
        return () => vue.h('button', { class: ['accordion-button', { ['collapsed']: props.collapsed }] }, slots.default && slots.default());
    },
});
...
const CAccordionHeader = vue.defineComponent({
    ...
    setup(_, { slots }) {
        return () => vue.h('div', { class: ['accordion-header'] }, slots.default && slots.default());
    },
});
...
const CDropdown = vue.defineComponent({
    ...
    setup(props, { slots }) {
        ...
        vue.watch(visible, () => props.popper && (visible.value ? initPopper() : destroyPopper()));
    ...
    setup(props, { slots, attrs, emit }) {
        ...
        return () => [
            vue.h(vue.Transition, {
                ...
                }, vue.h('div', { class: ['modal-content', props.className], ref: modalContentRef }, slots.default && slots.default())))),
            props.backdrop &&
                vue.h(CBackdrop, {
...
const CModalHeader = vue.defineComponent({
    ...
    setup(props, { slots, emit }) {
        ...
        return () => vue.h('span', { class: 'modal-header' }, [
            slots.default && slots.default(),
            props.dismiss && vue.h(CCloseButton, { onClick: handleDismiss }, ''),
        ]);
    },
});
...
const CPagination = vue.defineComponent({
    ...
    setup(props, { slots }) {
        return () => vue.h('nav', {}, vue.h('ul', { class: ['pagination', { [`pagination-${props.size}`]: props.size }] }, slots.default && slots.default()));
    },
});
...
const CSmartTableHead = vue.defineComponent({
    ...
    setup(props, { slots, emit }) {
        ...
        return () => vue.h(props.component === 'head' ? CTableHead : CTableFoot, {}, {
            default: () => [
                vue.h(CTableRow, {}, {
                    default: () => props.columns.map((column, index) => vue.h(CTableHeaderCell, {
                ...
                vue.h(CTableRow, {}, {
                    default: () => props.columns.map((column) => vue.h(CTableHeaderCell, {
                        ...tableHeaderCellProps(column),
                    }, {
...
const CSmartTable = vue.defineComponent({
    ...
    setup(props, { emit, slots }) {
        ...
        const numberOfPages = vue.computed(() => itemsPerPage.value ? Math.ceil(sortedItems.value.length / itemsPerPage.value) : 1); //!ok ||
        const firstItemOnActivePageIndex = vue.computed(() => activePage.value ? (activePage.value - 1) * itemsPerPage.value : 0); //!ok
...
const CToastClose = vue.defineComponent({
    ...
    setup(props, { slots, emit }) {
        ...
        return () => props.component
            ? vue.h(vue.resolveComponent(props.component), {
                onClick: () => {
                    handleClose();
                },
            }, slots.default && slots.default())
...
exports.CLoadingButtonPlugin = CLoadingButtonPlugin;
...
exports.CMultiSelectPlugin = CMultiSelectPlugin;
exports.CNav = CNav;
