...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div>`,5);function w(I,U){const a=p("RouterLink");return o(),l(c,null,[d,e("p",null,[b,m,h,v,f,_,g,y,k,i(a,{to:"/components/alert.html#customizing"},{default:t(()=>[x]),_:1})]),C],64)}var z=r(u,[["render",w],["__file","customize.html.vue"]]);export{z as default};
