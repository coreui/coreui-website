import{a0 as Q,_ as nn,o as en,c as rn,a as on}from"./app-gJDfq8z1.js";var W=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function tn(h){return h&&h.__esModule&&Object.prototype.hasOwnProperty.call(h,"default")?h.default:h}const an=`//
// Base styles
//
...
`,Be=`@mixin bsBanner($file) {
  /*!
   * CoreUI PRO #{$file} v5.0.0-rc.1 (https://coreui.io)
...
`,Pe=`// scss-docs-start caret-mixins
...
`,pr=`@each $color, $value in $theme-gradients {
  .bg-#{$color}-gradient {
...
`,ur=`// stylelint-disable scss/dimension-no-non-numeric-values
