import{a0 as Q,_ as nn,o as en,c as rn,a as on}from"./app-4lT4BHh0.js";var W=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function tn(h){return h&&h.__esModule&&Object.prototype.hasOwnProperty.call(h,"default")?h.default:h}const an=`//
// Base styles
//
...
`,pn=`// Make the div behave like a button
.btn-group,
.btn-group-vertical {
  position: relative;
  display: inline-flex;
...
`,fn=`// stylelint-disable selector-max-class
...
`,mn=`// Transparent background and border properties included for button version.
...
`,Fn=`// Responsive images (ensure images don't scale beyond their parents)
//
...
`,jn=`// Disable animation if transitions are disabled
...
`,Hn=`// stylelint-disable declaration-no-important, selector-no-qualifying-type, property-no-vendor-prefix
...
$elevation-base-color-dark:         0, 0, 0 !default;
...
`,qe=`@include deprecate("\`alert-variant()\`", "v5.0.0", "v6.0.0");
...
`,Te=`// Shared between modals and offcanvases
...
`,Be=`@mixin bsBanner($file) {
  /*!
   * CoreUI PRO #{$file} v5.0.0 (https://coreui.io)
   * Copyright (c) 2024 creativeLabs Łukasz Holeczek
   * License (https://coreui.io/pro/license/)
   */
}
`,De=`// stylelint-disable property-disallowed-list
...
`,Le=`// scss-docs-start caret-mixins
...
`,je=`// scss-docs-start color-mode-mixin
...
`,Ue=`@mixin elevation($value, $exclude: null) {
...
`,Ne=`// This mixin uses an \`if()\` technique to be compatible with Dart Sass
...
`,Ke=`@include deprecate("\`list-group-item-variant()\`", "v5.0.0", "v6.0.0");
...
`,ir=`// stylelint-disable property-disallowed-list
...
`,ar=`// stylelint-disable declaration-no-important
...
`,sr=`// stylelint-disable function-disallowed-list
...
`,cr="$variable-prefix:             cui- !default; // Deprecated in v4.2.6 for the shorter `$prefix`\n$prefix:                      $variable-prefix !default;\n",pr=`@import "variables";
...
/* rtl:end:ignore */
`,fr=`@mixin bsBanner($file) {
  /*!
   * CoreUI PRO for Bootstrap #{$file} v5.0.0-rc.1 (https://coreui.io/bootstrap/)
   * Copyright (c) 2024 creativeLabs Łukasz Holeczek
   * License (https://coreui.io/pro/license/)
   */
}
`,$r=`// Loop over each breakpoint
@each $breakpoint in map-keys($grid-breakpoints) {
...
`,br=`@each $color, $value in $theme-gradients {
  .bg-#{$color}-gradient {
    background-color: var(--#{$prefix}#{$color});
    background-image: linear-gradient(45deg, var(--#{$prefix}#{$color}-start) 0%, var(--#{$prefix}#{$color}-stop) 100%);
  }
}
`,gr=`// stylelint-disable scss/dimension-no-non-numeric-values
...
}`;var Z={exports:{}};(function(h){var O=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
 ...
 * @namespace
 * @public
 */var t=function(c){var f=/(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,x=0,k={},a={manual:c.Prism&&c.Prism.manual,disableWorkerMessageHandler:c.Prism&&c.Prism.disableWorkerMessageHandler,util:{encode:function e(n){return n instanceof v?new v(n.type,e(n.content),n.alias):Array.isArray(n)?n.map(e):n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/\u00a0/g," ")},type:function(e){return Object.prototype.toString.call(e).slice(8,-1)},objId:function(e){return e.__id||Object.defineProperty(e,"__id",{value:++x}),e.__id},clone:function e(n,r){r=r||{};var o,i;switch(a.util.type(n)){case"Object":if(i=a.util.objId(n),r[i])return r[i];o={},r[i]=o;for(var d in n)n.hasOwnProperty(d)&&(o[d]=e(n[d],r));return o;case"Array":return i=a.util.objId(n),r[i]?r[i]:(o=[],r[i]=o,n.forEach(function(s,l){o[l]=e(s,r)}),o);default:return n}},getLanguage:function(e){for(;e;){var n=f.exec(e.className);if(n)return n[1].toLowerCase();e=e.parentElement}return"none"},setLanguage:function(e,n){e.className=e.className.replace(RegExp(f,"gi"),""),e.classList.add("language-"+n)},currentScript:function(){if(typeof document>"u")return null;if("currentScript"in document&&1<2)return document.currentScript;try{throw new Error}catch(o){var e=(/at [^(\r\n]*\((.*):[^:]+:[^:]+\)$/i.exec(o.stack)||[])[1];if(e){var n=document.getElementsByTagName("script");for(var r in n)if(n[r].src==e)return n[r]}return null}},isActive:function(e,n,r){for(var o="no-"+n;e;){var i=e.classList;if(i.contains(n))return!0;if(i.contains(o))return!1;e=e.parentElement}return!!r}},languages:{plain:k,plaintext:k,text:k,txt:k,extend:function(e,n){var r=a.util.clone(a.languages[e]);for(var o in n)r[o]=n[o];return r},insertBefore:function(e,n,r,o){o=o||a.languages;var i=o[e],d={};for(var s in i)if(i.hasOwnProperty(s)){if(s==n)for(var l in r)r.hasOwnProperty(l)&&(d[l]=r[l]);r.hasOwnProperty(s)||(d[s]=i[s])}var u=o[e];return o[e]=d,a.languages.DFS(a.languages,function(g,_){_===u&&g!=e&&(this[g]=d)}),d},DFS:function e(n,r,o,i){i=i||{};var d=a.util.objId;for(var s in n)if(n.hasOwnProperty(s)){r.call(n,s,n[s],o||s);var l=n[s],u=a.util.type(l);u==="Object"&&!i[d(l)]?(i[d(l)]=!0,e(l,r,null,i)):u==="Array"&&!i[d(l)]&&(i[d(l)]=!0,e(l,r,s,i))}}},plugins:{},highlightAll:function(e,n){a.highlightAllUnder(document,e,n)},highlightAllUnder:function(e,n,r){var o={callback:r,container:e,selector:'code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'};a.hooks.run("before-highlightall",o),o.elements=Array.prototype.slice.apply(o.container.querySelectorAll(o.selector)),a.hooks.run("before-all-elements-highlight",o);for(var i=0,d;d=o.elements[i++];)a.highlightElement(d,n===!0,o.callback)},highlightElement:function(e,n,r){var o=a.util.getLanguage(e),i=a.languages[o];a.util.setLanguage(e,o);var d=e.parentElement;d&&d.nodeName.toLowerCase()==="pre"&&a.util.setLanguage(d,o);var s=e.textContent,l={element:e,language:o,grammar:i,code:s};function u(_){l.highlightedCode=_,a.hooks.run("before-insert",l),l.element.innerHTML=l.highlightedCode,a.hooks.run("after-highlight",l),a.hooks.run("complete",l),r&&r.call(l.element)}if(a.hooks.run("before-sanity-check",l),d=l.element.parentElement,d&&d.nodeName.toLowerCase()==="pre"&&!d.hasAttribute("tabindex")&&d.setAttribute("tabindex","0"),!l.code){a.hooks.run("complete",l),r&&r.call(l.element);return}if(a.hooks.run("before-highlight",l),!l.grammar){u(a.util.encode(l.code));return}if(n&&c.Worker){var g=new Worker(a.filename);g.onmessage=function(_){u(_.data)},g.postMessage(JSON.stringify({language:l.language,code:l.code,immediateClose:!0}))}else u(a.highlight(l.code,l.grammar,l.language))},highlight:function(e,n,r){var o={code:e,grammar:n,language:r};if(a.hooks.run("before-tokenize",o),!o.grammar)throw new Error('The language "'+o.language+'" has no grammar.');return o.tokens=a.tokenize(o.code,o.grammar),a.hooks.run("after-tokenize",o),v.stringify(a.util.encode(o.tokens),o.language)},tokenize:function(e,n){var r=n.rest;if(r){for(var o in r)n[o]=r[o];delete n.rest}var i=new C;return S(i,i.head,e),R(e,i,n,i.head,0),T(i)},hooks:{all:{},add:function(e,n){var r=a.hooks.all;r[e]=r[e]||[],r[e].push(n)},run:function(e,n){var r=a.hooks.all[e];if(!(!r||!r.length))for(var o=0,i;i=r[o++];)i(n)}},Token:v};c.Prism=a;function v(e,n,r,o){this.type=e,this.content=n,this.alias=r,this.length=(o||"").length|0}v.stringify=function e(n,r){if(typeof n=="string")return n;if(Array.isArray(n)){var o="";return n.forEach(function(u){o+=e(u,r)}),o}var i={type:n.type,content:e(n.content,r),tag:"span",classes:["token",n.type],attributes:{},language:r},d=n.alias;d&&(Array.isArray(d)?Array.prototype.push.apply(i.classes,d):i.classes.push(d)),a.hooks.run("wrap",i);var s="";for(var l in i.attributes)s+=" "+l+'="'+(i.attributes[l]||"").replace(/"/g,"&quot;")+'"';return"<"+i.tag+' class="'+i.classes.join(" ")+'"'+s+">"+i.content+"</"+i.tag+">"};function F(e,n,r,o){e.lastIndex=n;var i=e.exec(r);if(i&&o&&i[1]){var d=i[1].length;i.index+=d,i[0]=i[0].slice(d)}return i}function R(e,n,r,o,i,d){for(var s in r)if(!(!r.hasOwnProperty(s)||!r[s])){var l=r[s];l=Array.isArray(l)?l:[l];for(var u=0;u<l.length;++u){if(d&&d.cause==s+","+u)return;var g=l[u],_=g.inside,I=!!g.lookbehind,G=!!g.greedy,X=g.alias;if(G&&!g.pattern.global){var K=g.pattern.toString().match(/[imsuy]*$/)[0];g.pattern=RegExp(g.pattern.source,K+"g")}for(var U=g.pattern||g,m=o.next,y=i;m!==n.tail&&!(d&&y>=d.reach);y+=m.value.length,m=m.next){var A=m.value;if(n.length>e.length)return;if(!(A instanceof v)){var B=1,w;if(G){if(w=F(U,y,e,I),!w||w.index>=e.length)break;var D=w.index,Y=w.index+w[0].length,z=y;for(z+=m.value.length;D>=z;)m=m.next,z+=m.value.length;if(z-=m.value.length,y=z,m.value instanceof v)continue;for(var q=m;q!==n.tail&&(z<Y||typeof q.value=="string");q=q.next)B++,z+=q.value.length;B--,A=e.slice(y,z),w.index-=y}else if(w=F(U,0,A,I),!w)continue;var D=w.index,E=w[0],P=A.slice(0,D),N=A.slice(D+E.length),j=y+A.length;d&&j>d.reach&&(d.reach=j);var M=m.prev;P&&(M=S(n,M,P),y+=P.length),L(n,M,B);var J=new v(s,_?a.tokenize(E,_):E,X,E);if(m=S(n,M,J),N&&S(n,m,N),B>1){var H={cause:s+","+u,reach:j};R(e,n,r,m.prev,y,H),d&&H.reach>d.reach&&(d.reach=H.reach)}}}}}}function C(){var e={value:null,prev:null,next:null},n={value:null,prev:e,next:null};e.next=n,this.head=e,this.tail=n,this.length=0}function S(e,n,r){var o=n.next,i={value:r,prev:n,next:o};return n.next=i,o.prev=i,e.length++,i}function L(e,n,r){for(var o=n.next,i=0;i<r&&o!==e.tail;i++)o=o.next;n.next=o,o.prev=n,e.length-=i}function T(e){for(var n=[],r=e.head.next;r!==e.tail;)n.push(r.value),r=r.next;return n}if(!c.document)return c.addEventListener&&(a.disableWorkerMessageHandler||c.addEventListener("message",function(e){var n=JSON.parse(e.data),r=n.language,o=n.code,i=n.immediateClose;c.postMessage(a.highlight(o,a.languages[r],r)),i&&c.close()},!1)),a;var $=a.util.currentScript();$&&(a.filename=$.src,$.hasAttribute("data-manual")&&(a.manual=!0));function p(){a.manual||a.highlightAll()}if(!a.manual){var b=document.readyState;b==="loading"||b==="interactive"&&$&&$.defer?document.addEventListener("DOMContentLoaded",p):window.requestAnimationFrame?window.requestAnimationFrame(p):window.setTimeout(p,16)}return a}(O);h.exports&&(h.exports=t),typeof W<"u"&&(W.Prism=t),t.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]},t.languages.markup.tag.inside["attr-value"].inside.entity=t.languages.markup.entity,t.languages.markup.doctype.inside["internal-subset"].inside=t.languages.markup,t.hooks.add("wrap",function(c){c.type==="entity"&&(c.attributes.title=c.content.replace(/&amp;/,"&"))}),Object.defineProperty(t.languages.markup.tag,"addInlined",{value:function(f,x){var k={};k["language-"+x]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:t.languages[x]},k.cdata=/^<!\[CDATA\[|\]\]>$/i;var a={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:k}};a["language-"+x]={pattern:/[\s\S]+/,inside:t.languages[x]};var v={};v[f]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,function(){return f}),"i"),lookbehind:!0,greedy:!0,inside:a},t.languages.insertBefore("markup","cdata",v)}}),Object.defineProperty(t.languages.markup.tag,"addAttribute",{value:function(c,f){t.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+c+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[f,"language-"+f],inside:t.languages[f]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}}),t.languages.html=t.languages.markup,t.languages.mathml=t.languages.markup,t.languages.svg=t.languages.markup,t.languages.xml=t.languages.extend("markup",{}),t.languages.ssml=t.languages.xml,t.languages.atom=t.languages.xml,t.languages.rss=t.languages.xml,function(c){var f=/(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;c.languages.css={comment:/\/\*[\s\S]*?\*\//,atrule:{pattern:RegExp("@[\\w-](?:"+/[^;{\s"']|\s+(?!\s)/.source+"|"+f.source+")*?"+/(?:;|(?=\s*\{))/.source),inside:{rule:/^@[\w-]+/,"selector-function-argument":{pattern:/(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/,lookbehind:!0,alias:"selector"},keyword:{pattern:/(^|[^\w-])(?:and|not|only|or)(?![\w-])/,lookbehind:!0}}},url:{pattern:RegExp("\\burl\\((?:"+f.source+"|"+/(?:[^\\\r\n()"']|\\[\s\S])*/.source+")\\)","i"),greedy:!0,inside:{function:/^url/i,punctuation:/^\(|\)$/,string:{pattern:RegExp("^"+f.source+"$"),alias:"url"}}},selector:{pattern:RegExp(`(^|[{}\\s])[^{}\\s](?:[^{};"'\\s]|\\s+(?![\\s{])|`+f.source+")*(?=\\s*\\{)"),lookbehind:!0},string:{pattern:f,greedy:!0},property:{pattern:/(^|[^-\w\xA0-\uFFFF])(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i,lookbehind:!0},important:/!important\b/i,function:{pattern:/(^|[^-a-z0-9])[-a-z0-9]+(?=\()/i,lookbehind:!0},punctuation:/[(){};:,]/},c.languages.css.atrule.inside.rest=c.languages.css;var x=c.languages.markup;x&&(x.tag.addInlined("style","css"),x.tag.addAttribute("style","css"))}(t),t.languages.clike={comment:[{pattern:/(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,lookbehind:!0,greedy:!0},{pattern:/(^|[^\\:])\/\/.*/,lookbehind:!0,greedy:!0}],string:{pattern:/(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,greedy:!0},"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|trait)\s+|\bcatch\s+\()[\w.\\]+/i,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:break|catch|continue|do|else|finally|for|function|if|in|instanceof|new|null|return|throw|try|while)\b/,boolean:/\b(?:false|true)\b/,function:/\b\w+(?=\()/,number:/\b0x[\da-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:e[+-]?\d+)?/i,operator:/[<>]=?|[!=]=?=?|--?|\+\+?|&&?|\|\|?|[?*/~^%]/,punctuation:/[{}[\];(),.:]/},t.languages.javascript=t.languages.extend("clike",{"class-name":[t.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+(/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source)+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/}),t.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/,t.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:t.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:t.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:t.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:t.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:t.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/}),t.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:t.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}}),t.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}}),t.languages.markup&&(t.languages.markup.tag.addInlined("script","javascript"),t.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript")),t.languages.js=t.languages.javascript,function(){if(typeof t>"u"||typeof document>"u")return;Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector);var c="Loading…",f=function($,p){return"✖ Error "+$+" while fetching file: "+p},x="✖ Error: File does not exist or is empty",k={js:"javascript",py:"python",rb:"ruby",ps1:"powershell",psm1:"powershell",sh:"bash",bat:"batch",h:"c",tex:"latex"},a="data-src-status",v="loading",F="loaded",R="failed",C="pre[data-src]:not(["+a+'="'+F+'"]):not(['+a+'="'+v+'"])';function S($,p,b){var e=new XMLHttpRequest;e.open("GET",$,!0),e.onreadystatechange=function(){e.readyState==4&&(e.status<400&&e.responseText?p(e.responseText):e.status>=400?b(f(e.status,e.statusText)):b(x))},e.send(null)}function L($){var p=/^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec($||"");if(p){var b=Number(p[1]),e=p[2],n=p[3];return e?n?[b,Number(n)]:[b,void 0]:[b,b]}}t.hooks.add("before-highlightall",function($){$.selector+=", "+C}),t.hooks.add("before-sanity-check",function($){var p=$.element;if(p.matches(C)){$.code="",p.setAttribute(a,v);var b=p.appendChild(document.createElement("CODE"));b.textContent=c;var e=p.getAttribute("data-src"),n=$.language;if(n==="none"){var r=(/\.(\w+)$/.exec(e)||[,"none"])[1];n=k[r]||r}t.util.setLanguage(b,n),t.util.setLanguage(p,n);var o=t.plugins.autoloader;o&&o.loadLanguages(n),S(e,function(i){p.setAttribute(a,F);var d=L(p.getAttribute("data-range"));if(d){var s=i.split(/\r\n?|\n/g),l=d[0],u=d[1]==null?s.length:d[1];l<0&&(l+=s.length),l=Math.max(0,Math.min(l-1,s.length)),u<0&&(u+=s.length),u=Math.max(0,Math.min(u,s.length)),i=s.slice(l,u).join(`
`),p.hasAttribute("data-start")||p.setAttribute("data-start",String(l+1))}b.textContent=i,t.highlightElement(b)},function(i){p.setAttribute(a,R),b.textContent=i})}}),t.plugins.fileHighlight={highlight:function(p){for(var b=(p||document).querySelectorAll(C),e=0,n;n=b[e++];)t.highlightElement(n)}};var T=!1;t.fileHighlight=function(){T||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),T=!0),t.plugins.fileHighlight.highlight.apply(this,arguments)}}()})(Z);var mr=Z.exports;const V=tn(mr);Prism.languages.scss=Prism.languages.extend("css",{comment:{pattern:/(^|[^\\])(?:\/\*[\s\S]*?\*\/|\/\/.*)/,lookbehind:!0},atrule:{pattern:/@[\w-](?:\([^()]+\)|[^()\s]|\s+(?!\s))*?(?=\s+[{;])/,inside:{rule:/@[\w-]+/}},url:/(?:[-a-z]+-)?url(?=\()/i,selector:{pattern:/(?=\S)[^@;{}()]?(?:[^@;{}()\s]|\s+(?!\s)|#\{\$[-\w]+\})+(?=\s*\{(?:\}|\s|[^}][^:{}]*[:{][^}]))/,inside:{parent:{pattern:/&/,alias:"important"},placeholder:/%[-\w]+/,variable:/\$[-\w]+|#\{\$[-\w]+\}/}},property:{pattern:/(?:[-\w]|\$[-\w]|#\{\$[-\w]+\})+(?=\s*:)/,inside:{variable:/\$[-\w]+|#\{\$[-\w]+\}/}}});Prism.languages.insertBefore("scss","atrule",{keyword:[/@(?:content|debug|each|else(?: if)?|extend|for|forward|function|if|import|include|mixin|return|use|warn|while)\b/i,{pattern:/( )(?:from|through)(?= )/,lookbehind:!0}]});Prism.languages.insertBefore("scss","important",{variable:/\$[-\w]+|#\{\$[-\w]+\}/});Prism.languages.insertBefore("scss","function",{"module-modifier":{pattern:/\b(?:as|hide|show|with)\b/i,alias:"keyword"},placeholder:{pattern:/%[-\w]+/,alias:"selector"},statement:{pattern:/\B!(?:default|optional)\b/i,alias:"keyword"},boolean:/\b(?:false|true)\b/,null:{pattern:/\bnull\b/,alias:"keyword"},operator:{pattern:/(\s)(?:[-+*\/%]|[=!]=|<=?|>=?|and|not|or)(?=\s)/,lookbehind:!0}});Prism.languages.scss.atrule.inside.rest=Prism.languages.scss;const vr=Q({name:"ScssDocs",props:{capture:String,file:String},setup(h){typeof window<"u"&&(window.Prism=window.Prism||{},window.Prism.manual=!0);const t=Object.assign({"../../../../../../../node_modules/@coreui/coreui-pro/scss/_accordion.scss":an,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_alert.scss":ln,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_avatar.scss":dn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_badge.scss":sn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_breadcrumb.scss":cn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_button-group.scss":pn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_buttons.scss":un,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_calendar.scss":fn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_callout.scss":$n,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_card.scss":bn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_carousel.scss":gn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_close.scss":mn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_containers.scss":vn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_date-picker.scss":hn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_dropdown.scss":xn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_footer.scss":kn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_forms.scss":wn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_functions.scss":yn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_grid.scss":_n,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_header.scss":zn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_helpers.scss":Sn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_icon.scss":An,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_images.scss":Fn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_list-group.scss":Cn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_loading-button.scss":qn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_maps.scss":Rn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_mixins.scss":Tn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_modal.scss":Bn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_nav.scss":Dn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_navbar.scss":En,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_offcanvas.scss":Mn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_pagination.scss":On,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_placeholders.scss":Ln,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_popover.scss":Pn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_progress.scss":jn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_reboot.scss":Hn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_root.scss":In,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_sidebar.scss":Gn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_spinners.scss":Un,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_tables.scss":Nn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_time-picker.scss":Wn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_toasts.scss":Vn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_tooltip.scss":Zn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_transitions.scss":Xn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_type.scss":Kn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_utilities.scss":Yn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_variables-dark.scss":Jn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/_variables.scss":Qn,"../../../../../../../node_modules/@coreui/coreui-pro/scss/coreui-grid.rtl.scss":ne,"../../../../../../../node_modules/@coreui/coreui-pro/scss/coreui-grid.scss":ee,"../../../../../../../node_modules/@coreui/coreui-pro/scss/coreui-reboot.rtl.scss":re,"../../../../../../../node_modules/@coreui/coreui-pro/scss/coreui-reboot.scss":oe,"../../../../../../../node_modules/@coreui/coreui-pro/scss/coreui-utilities.rtl.scss":ie,"../../../../../../../node_modules/@coreui/coreui-pro/scss/coreui-utilities.scss":te,"../../../../../../../node_modules/@coreui/coreui-pro/scss/coreui.rtl.scss":ae,"../../../../../../../node_modules/@coreui/coreui-pro/scss/coreui.scss":le,"../../../../../../../node_modules/@coreui/coreui-pro/scss/forms/_floating-labels.scss":de,"../../../../../../../node_modules/@coreui/coreui-pro/scss/forms/_form-check.scss":se,"../../../../../../../node_modules/@coreui/coreui-pro/scss/forms/_form-control.scss":ce,"../../../../../../../node_modules/@coreui/coreui-pro/scss/forms/_form-multi-select.scss":pe,"../../../../../../../node_modules/@coreui/coreui-pro/scss/forms/_form-range.scss":ue,"../../../../../../../node_modules/@coreui/coreui-pro/scss/forms/_form-select.scss":fe,"../../../../../../../node_modules/@coreui/coreui-pro/scss/forms/_form-text.scss":$e,"../../../../../../../node_modules/@coreui/coreui-pro/scss/forms/_input-group.scss":be,"../../../../../../../node_modules/@coreui/coreui-pro/scss/forms/_labels.scss":ge,"../../../../../../../node_modules/@coreui/coreui-pro/scss/forms/_validation.scss":me,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_clearfix.scss":ve,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_color-bg.scss":he,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_colored-links.scss":xe,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_focus-ring.scss":ke,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_icon-link.scss":we,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_position.scss":ye,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_ratio.scss":_e,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_stacks.scss":ze,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_stretched-link.scss":Se,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_text-truncation.scss":Ae,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_visually-hidden.scss":Fe,"../../../../../../../node_modules/@coreui/coreui-pro/scss/helpers/_vr.scss":Ce,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_alert.scss":qe,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_avatar.scss":Re,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_backdrop.scss":Te,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_banner.scss":Be,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_border-radius.scss":De,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_box-shadow.scss":Ee,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_breakpoints.scss":Me,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_buttons.scss":Oe,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_caret.scss":Le,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_clearfix.scss":Pe,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_color-mode.scss":je,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_color-scheme.scss":He,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_container.scss":Ie,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_deprecate.scss":Ge,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_elevation.scss":Ue,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_forms.scss":Ne,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_gradients.scss":We,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_grid.scss":Ve,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_icon.scss":Ze,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_image.scss":Xe,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_list-group.scss":Ke,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_lists.scss":Ye,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_ltr-rtl.scss":Je,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_pagination.scss":Qe,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_reset-text.scss":nr,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_resize.scss":er,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_table-variants.scss":rr,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_text-truncate.scss":or,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_transition.scss":ir,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_utilities.scss":tr,"../../../../../../../node_modules/@coreui/coreui-pro/scss/mixins/_visually-hidden.scss":ar,"../../../../../../../node_modules/@coreui/coreui-pro/scss/sidebar/_sidebar-narrow.scss":lr,"../../../../../../../node_modules/@coreui/coreui-pro/scss/sidebar/_sidebar-nav.scss":dr,"../../../../../../../node_modules/@coreui/coreui-pro/scss/sidebar/_sidebar.scss":sr,"../../../../../../../node_modules/@coreui/coreui-pro/scss/themes/bootstrap/_variables.scss":cr,"../../../../../../../node_modules/@coreui/coreui-pro/scss/themes/bootstrap/bootstrap.rtl.scss":pr,"../../../../../../../node_modules/@coreui/coreui-pro/scss/themes/bootstrap/bootstrap.scss":ur,"../../../../../../../node_modules/@coreui/coreui-pro/scss/themes/bootstrap/mixins/_banner.scss":fr,"../../../../../../../node_modules/@coreui/coreui-pro/scss/utilities/_api.scss":$r,"../../../../../../../node_modules/@coreui/coreui-pro/scss/utilities/_bg-gradients.scss":br,"../../../../../../../node_modules/@coreui/coreui-pro/scss/vendor/_rfs.scss":gr})[`../../../../../../../node_modules/@coreui/coreui-pro/scss/${h.file}`],c=`// scss-docs-start ${h.capture}`,f=`// scss-docs-end ${h.capture}`,k=new RegExp(`${c}((?:.|
)*)${f}`).exec(t),a=k&&k[1].trim();return{code:a?V.highlight(a.replaceAll("--#{$prefix}","--cui-").replaceAll(`
  -`,`
-`).replaceAll(`
  @`,`
@`),V.languages.scss,"scss"):null}}}),hr={class:"highlight"},xr=["innerHTML"];function kr(h,O,t,c,f,x){return en(),rn("div",hr,[on("pre",{class:"prism-code language-scss",innerHTML:h.code},null,8,xr)])}const yr=nn(vr,[["render",kr],["__file","ScssDocs.vue"]]);export{yr as default};
