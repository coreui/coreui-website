# Vue Focus Trap Component API

> Explore the API reference for the Vue Focus Trap component and discover how to effectively utilize its props for customization.
