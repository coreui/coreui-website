...
> LLM-optimized documentation endpoints for CoreUI for React — llms.txt, llms-full.txt, and a Markdown version of every page.
...
For a richer, tool-based integration, see [MCP Server](https://coreui.io/react/docs/ai-tools/mcp/).
...
For example: [/react/docs/components/accordion.md](https://coreui.io/react/docs/components/accordion.md)
