...
| `calendars` | `number \| undefined` | `2` | The number of calendars that render on desktop devices. |
...
| `cleaner` | `boolean \| undefined` | `true` | Toggle visibility or set the content of the cleaner button. |
| `closeOnSelect` | `boolean \| undefined` | `true` | If true the dropdown will be immediately closed after submitting the full date. |
...
| `placeholder` | `string \| string[] \| undefined` | `['Start date', 'End date']` | Specifies short hints that are visible in start date and end date inputs. |
| `portal` | `boolean \| undefined` | `true` | Generates dropdown menu using createPortal. |
| `previewDateOnHover` | `boolean \| undefined` | `true` | Enable live preview of dates in input fields when hovering over calendar cells. |
| `ranges` | `object \| undefined` | - | Predefined date ranges the user can select from. |
...
| `rangesButtonsVariant` | `"outline" \| "ghost" \| undefined` | `ghost` | Set the ranges button variant to an outlined button or a ghost button. |
