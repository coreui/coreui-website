# React Form Radio Component API

> Explore the API reference for the React Form Radio component and discover how to effectively utilize its props for customization.
...
| --- | --- | --- | --- |
| `button` | `ButtonObject` | - | Create button-like checkboxes and radio buttons. |
...
| `hitArea` | `"full"` | - | Sets hit area to the full area of the component. |
...
| `inline` | `boolean` | - | Group checkboxes or radios on the same horizontal row. |
