...
| `layout` | `"horizontal" \| "horizontal-sm" \| "horizontal-md" \| "horizontal-lg" \| "horizontal-xl" \| "horizontal-xxl"` | - | Specify a layout type. |
...
| `as` | `(ElementType & "symbol") \| (ElementType & "object") \| (ElementType & "li") \| (ElementType & "slot") \| (ElementType & "style") \| ... 175 more ...` | `li` | Component used for the root node. Either a string to use a HTML element or a component. |
| `className` | `string` | - | A string of all className you want applied to the component. |
