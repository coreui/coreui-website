...
| --- | --- | --- | --- |
| `align` | `string \| undefined` | - | Set the vertical aligment. |
...
| `bordered` | `boolean \| undefined` | - | Add borders on all sides of the table and cells. |
| `borderless` | `boolean \| undefined` | - | Remove borders on all sides of the table and cells. |
| `caption` | `string \| undefined` | - | Put the caption on the top if you set `caption="top"` of the table or set the text of the table caption. |
| `captionTop` | `string \| undefined` | - | Set the text of the table caption and the caption on the top of the table. |
...
| `footer` | `(string \| FooterItem)[] \| undefined` | - | Array of objects or strings, where each element represents one cell in the table footer. Example items: `['FooterCell', 'FooterCell', 'FooterCell']` or `[{ label: 'FooterCell', _props: { color: 'success' }, ...]` |
| `hover` | `boolean \| undefined` | - | Enable a hover state on table rows within a `<CTableBody>`. |
...
| `responsive` | `boolean \| "sm" \| "md" \| "lg" \| "xl" \| "xxl" \| undefined` | - | Make any table responsive across all viewports or pick a maximum breakpoint with which to have a responsive table up to. |
| `small` | `boolean \| undefined` | - | Make table more compact by cutting all cell `padding` in half. |
| `striped` | `boolean \| undefined` | - | Add zebra-striping to any table row within the `<CTableBody>`. |
| `stripedColumns` | `boolean \| undefined` | - | Add zebra-striping to any table column. |
| `tableFootProps` | `CTableFootProps \| undefined` | - | Properties that will be passed to the table footer component. |
| `tableHeadProps` | `CTableHeadProps \| undefined` | - | Properties that will be passed to the table head component. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `active` | `boolean \| undefined` | - | Highlight a table row or cell. |
| `align` | `string \| undefined` | - | Set the vertical aligment. |
| `className` | `string \| undefined` | - | A string of all className you want applied to the component. |
| `color` | `'primary' \| 'secondary' \| 'success' \| 'danger' \| 'warning' \| 'info' \| 'dark' \| 'light' \| string` | - | Sets the color context of the component to one of CoreUI’s themed colors. |
