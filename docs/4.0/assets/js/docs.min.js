...
*/(function(){'use strict'
document.querySelectorAll('.tooltip-demo').forEach(function(tooltip){new coreui.Tooltip(tooltip,{selector:'[data-coreui-toggle="tooltip"]'})})
document.querySelectorAll('[data-coreui-toggle="popover"]').forEach(function(popover){new coreui.Popover(popover)})
...
document.querySelectorAll('.toast').forEach(function(toastNode){var toast=new coreui.Toast(toastNode,{autohide:false})
toast.show()})
document.querySelectorAll('.tooltip-test').forEach(function(tooltip){new coreui.Tooltip(tooltip)})
document.querySelectorAll('.popover-test').forEach(function(popover){new coreui.Popover(popover)})
document.querySelectorAll('.docs-example-indeterminate [type="checkbox"]').forEach(function(checkbox){checkbox.indeterminate=true})
document.querySelectorAll('.docs-content [href="#"]').forEach(function(link){link.addEventListener('click',function(e){e.preventDefault()})})
var exampleModal=document.getElementById('exampleModal')
if(exampleModal){exampleModal.addEventListener('show.coreui.modal',function(event){var button=event.relatedTarget
...
document.querySelectorAll('.btn-clipboard').forEach(function(btn){var tooltipBtn=new coreui.Tooltip(btn)
...
clipboard.on('success',function(e){var tooltipBtn=coreui.Tooltip.getInstance(e.trigger)
...
anchors.add('.docs-content > h2, .docs-content > h3, .docs-content > h4, .docs-content > h5')})();(function(){'use strict'
